	...
	if(pauseEnabled == true){
		...
		if(GUI.Button(Rect(Screen.width /2 - 100,Screen.height /2 -50,250,50), "Main Menu")){
			Application.LoadLevel(mainMenuSceneName);
				...
				//Make Scene1 button
		if(GUI.Button(Rect(Screen.width /2 - 100,Screen.height /2 ,250,50), "Scene 1")){
			Application.LoadLevel("1-Labyrint");
		
		}
		//Make Scene2 button
		if(GUI.Button(Rect(Screen.width /2 - 100,Screen.height /2 + 50,250,50), "Scene 2")){
			Application.LoadLevel("2-Placering");
		}

				//Make Scene3 button
		if(GUI.Button(Rect(Screen.width /2 - 100,Screen.height /2 + 100,250,50), "Scene 3")){
			Application.LoadLevel("3-Location");
		}

				//Make Scene4 button
		if(GUI.Button(Rect(Screen.width /2 - 100,Screen.height /2 + 150,250,50), "Scene 4")){
			Application.LoadLevel("4-Finale");
		}
		...
		//Make Change Graphics Quality button
			if(GUI.Button(Rect(Screen.width /2 - 100,Screen.height /2 + 200,250,50), "Change Graphics Quality")){
		...
		if (GUI.Button (Rect (Screen.width /2 - 100,Screen.height /2 + 250,250,50), "Quit Game")){
			Application.Quit();
		}
	}
}
